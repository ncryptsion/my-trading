...
instrument{name="SCRIPT AHORA",icon='https://lh3.googleusercontent.com/ogw/ADea4I65OapvF7ZOUMZc_3J4Yx__qVmvJD_jgzr4p8MZNks=s32-c-mo',overlay=true}
...
instrument { name = "SCRIPT AHORA", icon="indicators:ADX", overlay = true }
method_id = input (1, "Type", input.string_selection, { "SCRIPT AHORA" })


instrument {
    name = 'SCRIPT AHORA',
    short_name = 'SCRIPT AHORA',
  icon = 'indicators:BB',
    overlay = true
}
